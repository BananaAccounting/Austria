...
//
// @id = ch.banana.a.app.vatreportaustria2023
// @api = 1.0
// @pubdate = 2023-02-21
// @publisher = Banana.ch SA
// @description = VAT report Austria 2023
// @task = app.command
...
function loadParam(banDoc, startDate, endDate) {
	param = {
		"reportName":"VAT report Austria 2023",												//Save the report's name
		"bananaVersion":"Banana Accounting Plus", 											//Save the version of Banana Accounting used
		"scriptVersion":"script v. 2023-02-21",				 								//Save the version of the script

...
//
// @id = ch.banana.a.app.vatreportaustria2019
// @api = 1.0
// @pubdate = 2019-04-10
// @publisher = Banana.ch SA
// @description = VAT report Austria 2019
// @task = app.command
...
function loadParam(banDoc, startDate, endDate) {
	param = {
		"reportName":"VAT report Austria 2019",												//Save the report's name
		"bananaVersion":"Banana Accounting 9", 												//Save the version of Banana Accounting used
		"scriptVersion":"script v. 2019-04-16",				 								//Save the version of the script
...
function createVatReport(banDoc, startDate, endDate, isTest) {
	...
	//Title
	report.addParagraph("[  ] Umsatzsteuervoranmeldung 2019", "heading1");		
	report.addParagraph("[  ] Berichtige Umsatzsteuervoranmeldung 2019", "heading1");

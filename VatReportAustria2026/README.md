...
4. Select the "Vat Report Austria 2026" Banana extension and click on "Install". 
5. Open example file: "MusterdateiUSt2026.ac2"
6. Menu Extensions > VAT report Austria 2026


## Modify the VatTable to use the script
If you have an existing accounting file you need to adapt the VatCode Table.
See the example file "MusterdateiUSt2026.ac2"

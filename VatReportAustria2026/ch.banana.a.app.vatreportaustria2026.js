...
function loadForm() {
	...
	form.push({"id":"4.15.1", "gr":"124", "vatClass":"2", "description":"4,9% ermäßigter Steuersatz"});
	form.push({"id":"4.15.2", "gr":"124", "vatClass":"4", "description":"4,9% ermäßigter Steuersatz"});		
	form.push({"id":"4.16.1", "gr":"029", "vatClass":"2", "description":"10% ermäßigter Steuersatz"});
	form.push({"id":"4.16.2", "gr":"029", "vatClass":"4", "description":"10% ermäßigter Steuersatz"});		
	form.push({"id":"4.17.1", "gr":"006", "vatClass":"2", "description":"13% ermäßigter Steuersatz"});
	form.push({"id":"4.17.2", "gr":"006", "vatClass":"4", "description":"13% ermäßigter Steuersatz"});
	form.push({"id":"4.18.1", "gr":"037", "vatClass":"2", "description":"19% für Jungholz und Mittelberg"});
	form.push({"id":"4.18.2", "gr":"037", "vatClass":"4", "description":"19% für Jungholz und Mittelberg"});	
	form.push({"id":"4.19.1", "gr":"052", "vatClass":"2", "description":"10% Zusatzsteuer für pauschalierte land- und forstwirtschaftliche Betriebe"});
	form.push({"id":"4.19.2", "gr":"052", "vatClass":"4", "description":"10% Zusatzsteuer für pauschalierte land- und forstwirtschaftliche Betriebe"});
	form.push({"id":"4.20.1", "gr":"007", "vatClass":"2", "description":"7% Zusatzsteuer für pauschalierte land- und forstwirtschaftliche Betriebe"});
	form.push({"id":"4.20.2", "gr":"007", "vatClass":"4", "description":"7% Zusatzsteuer für pauschalierte land- und forstwirtschaftliche Betriebe"});
	...
	form.push({"id":"4.30.1", "gr":"125", "vatClass":"2", "description":"4,9% ermäßigter Steuersatz"});
	form.push({"id":"4.30.2", "gr":"125", "vatClass":"4", "description":"4,9% ermäßigter Steuersatz"});
	form.push({"id":"4.31.1", "gr":"073", "vatClass":"2", "description":"10% ermäßigter Steuersatz"});
	form.push({"id":"4.31.2", "gr":"073", "vatClass":"4", "description":"10% ermäßigter Steuersatz"});
	form.push({"id":"4.32.1", "gr":"008", "vatClass":"2", "description":"13% ermäßigter Steuersatz"});
	form.push({"id":"4.32.2", "gr":"008", "vatClass":"4", "description":"13% ermäßigter Steuersatz"});
	form.push({"id":"4.33.1", "gr":"088", "vatClass":"2", "description":"19% für Jungholz und Mittelberg"});
	form.push({"id":"4.33.2", "gr":"088", "vatClass":"4", "description":"19% für Jungholz und Mittelberg"});
...
function exec(string) {
	...
	var isCurrentBananaVersionSupported = bananaRequiredVersion("10.0.1", "");
...
function createVatReport(banDoc, startDate, endDate, isTest) {
	...
	var year = Banana.Converter.toDate(param.startDate).getFullYear();
		
	//Title
	report.addParagraph("[  ] Umsatzsteuervoranmeldung " + year, "heading1");		
	report.addParagraph("[  ] Berichtige Umsatzsteuervoranmeldung " + year, "heading1");
...
function bananaRequiredVersion(requiredVersion, expmVersion) {
	...
	if (Banana.compareVersion && Banana.compareVersion(Banana.application.version, requiredVersion) < 0) {
		...
		Banana.document.addMessage("Um diese Erweiterung zu benutzen, müssen Sie Banana Buchhaltung Plus (Professional-Plan) verwenden.");
		return false;
	}
	else {

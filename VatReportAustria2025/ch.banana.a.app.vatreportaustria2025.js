...
//
// @id = ch.banana.a.app.vatreportaustria2025
// @api = 1.0
// @pubdate = 2025-02-11
// @publisher = Banana.ch SA
// @description = VAT report Austria 2025
// @task = app.command
...
function loadParam(banDoc, startDate, endDate) {
	param = {
		"reportName":"VAT report Austria 2025",												//Save the report's name
		"bananaVersion":"Banana Accounting Plus", 											//Save the version of Banana Accounting used
		"scriptVersion":"script v. 2025-02-11",				 								//Save the version of the script

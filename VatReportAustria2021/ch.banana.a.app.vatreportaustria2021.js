...
//
// @id = ch.banana.a.app.vatreportaustria2021
// @api = 1.0
// @pubdate = 2021-02-12
// @publisher = Banana.ch SA
// @description = VAT report Austria 2021
// @task = app.command
...
function loadParam(banDoc, startDate, endDate) {
	param = {
		"reportName":"VAT report Austria 2021",												//Save the report's name
		"bananaVersion":"Banana Accounting", 												//Save the version of Banana Accounting used
		"scriptVersion":"script v. 2021-02-12",				 								//Save the version of the script
...
function createVatReport(banDoc, startDate, endDate, isTest) {
	...
	//Title
	report.addParagraph("[  ] Umsatzsteuervoranmeldung 2021", "heading1");		
	report.addParagraph("[  ] Berichtige Umsatzsteuervoranmeldung 2021", "heading1");

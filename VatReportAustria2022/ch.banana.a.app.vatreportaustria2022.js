...
//
// @id = ch.banana.a.app.vatreportaustria2022
// @api = 1.0
// @pubdate = 2022-01-25
// @publisher = Banana.ch SA
// @description = VAT report Austria 2022
// @task = app.command
...
function loadParam(banDoc, startDate, endDate) {
	param = {
		"reportName":"VAT report Austria 2022",												//Save the report's name
		"bananaVersion":"Banana Accounting Plus", 											//Save the version of Banana Accounting used
		"scriptVersion":"script v. 2022-01-25",				 								//Save the version of the script
...
function createVatReport(banDoc, startDate, endDate, isTest) {
	...
	//Title
	report.addParagraph("[  ] Umsatzsteuervoranmeldung 2022", "heading1");		
	report.addParagraph("[  ] Berichtige Umsatzsteuervoranmeldung 2022", "heading1");

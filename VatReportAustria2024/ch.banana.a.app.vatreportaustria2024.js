...
//
// @id = ch.banana.a.app.vatreportaustria2024
// @api = 1.0
// @pubdate = 2024-02-07
// @publisher = Banana.ch SA
// @description = VAT report Austria 2024
// @task = app.command
...
function loadParam(banDoc, startDate, endDate) {
	param = {
		"reportName":"VAT report Austria 2024",												//Save the report's name
		"bananaVersion":"Banana Accounting Plus", 											//Save the version of Banana Accounting used
		"scriptVersion":"script v. 2024-02-07",				 								//Save the version of the script
